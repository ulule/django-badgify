...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_table(u'badgify_badge', (
        ...
        db.send_create_signal('badgify', ['Badge'])
        db.create_table(u'badgify_award', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='badges', to=orm[user_orm_label])),
            ('badge', self.gf('django.db.models.fields.related.ForeignKey')(related_name='awards', to=orm['badgify.Badge'])),
            ('awarded_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('badgify', ['Award'])
        db.create_unique(u'badgify_award', ['user_id', 'badge_id'])
